...
public class DialogManager2 : MonoBehaviour
{
    ...
    public Man2DayOneCorrectController2 man2NPC; // Referenca na Man2DayOneCorrectController
    ...
    public void StartDialog(Dialog dialog, MafiaNPCController2 npc)
    {
    ...
    public void DisplayNextSentence(MafiaNPCController2 npc)
    {
    ...
    public void EndDialog(MafiaNPCController2 npc)
    {
        if (npc == null || !npc.gameObject.activeInHierarchy)
        {
            Debug.LogError("MafiaNPCController nije pronađen ili je deaktiviran!");
    ...
    void Update()
    {
        MafiaNPCController2 npc = FindObjectOfType<MafiaNPCController2>();
