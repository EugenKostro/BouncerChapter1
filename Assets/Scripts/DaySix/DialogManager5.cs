...
public class DialogManager5 : MonoBehaviour
{
    ...
    public Man2DayOneCorrectController5 man2NPC; // Referenca na Man2DayOneCorrectController
    ...
    public void StartDialog(Dialog dialog, MafiaNPCController5 npc)
    {
    ...
    public void DisplayNextSentence(MafiaNPCController5 npc)
    {
    ...
    public void EndDialog(MafiaNPCController5 npc)
    {
        if (npc == null || !npc.gameObject.activeInHierarchy)
        {
            Debug.LogError("MafiaNPCController nije pronađen ili je deaktiviran!");
    ...
    void Update()
    {
        MafiaNPCController5 npc = FindObjectOfType<MafiaNPCController5>();
